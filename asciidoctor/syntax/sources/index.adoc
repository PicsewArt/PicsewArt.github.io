...
:toc: left
:toclevels: 6
:toc-title: 索引 Table of Contents
...
image::{image}/md_standards.png[title="Markdown Standards"]
...
....
[.right.text-center]
image::{image}/avatar.png[Avatar,200,200]
....
...
[source, asciidoc]
....
An image image:{image}/avatar.png[Avatar, 50] here.
....
...
[source, asciidoc]
....
image::{image}/avatar.png[caption="Caption: ", title="Blocked Image", 100]
....
...
==== 问答列表 Question and Answer Lists
